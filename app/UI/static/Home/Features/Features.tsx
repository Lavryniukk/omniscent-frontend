...
let Features = () => {
  return (
    <div className="box-border w-full flex items-center justify-center flex-col py-20 mx-auto space-y-10 overflow-x-hidden font-normal px-4 bg-transparent relative section max-w-10xl">
