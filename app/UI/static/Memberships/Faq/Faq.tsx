...
let FAQ = ({ faqArray }: { faqArray: Array<FaqItem> }) => {
  ...
  w-full my-32 h-fit justify-around items-center "
    >
      <h2 className="text-4xl sm:text-5xl duration-500 transition-all font-inter mx-auto font-bold text-center text-text">
        FAQ
      </h2>
      <div className="sm:p-8 p-4 space-y-5 duration-500 transition">
