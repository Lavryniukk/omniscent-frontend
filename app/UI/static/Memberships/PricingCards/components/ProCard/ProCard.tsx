...
let ProCard = () => {
  ...
  return (
    <div className=" md:-translate-x-5 mx-auto sm:m-0 z-20 shadow-[0px_0px_30px_0px_rgb(var(--text))] md:shadow-[10px_10px_35px_0px_rgb(var(--text))] border-t border-r duration-500 transition delay-75 w-[350px] sm:w-[450px] md:w-[400px] lg:w-[450px]  p-8 relative bg-background h-fit bg-opacity-90 rounded-xl border-secondary">
