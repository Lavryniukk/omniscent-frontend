...
let Header = () => {
    return <div className="border-b h-14 flex w-full justify-center fixed top-0.5 z-10 border-accent box-border ">
       
        <div className="w-full h-14 fixed top-0 backdrop-blur-sm flex
