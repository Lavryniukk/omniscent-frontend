...
let Reviews = () => {
  return (
    <div className=" relative overflow-hidden border-t border-secondary w-full mx-auto before:absolute before:top-0 before:w-full before:right-0 before:h-16 before:bg-gradient-to-t before:from-background before:to-primary-950 before:blur-3xl">
