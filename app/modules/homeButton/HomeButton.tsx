...
let HomeButton = () => {
  return (
    <Link
      ...
      className="fixed select-none cursor-pointer top-10 group left-10 hover:shadow-xl box-content rounded-lg w-[52px] h-9 flex justify-center items-center"
    >
      <div className="bg-primary rounded-lg absolute right-0 box-content transition-all duration-300 group-hover:w-full h-full w-0 "></div>
