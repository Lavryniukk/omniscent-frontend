...
let Features = () => {
  return (
	...
	w-full"
    >
      <h2 className="text-text font-roboto font-medium mx-auto  text-center text-4xl">
        What`s Omniscient?
      </h2>
      <p className="font-roboto font-light mx-auto text-accent text-lg w-1/2 mt-16">
      ...
      <div className="grid mt-10 w-full h-fit box-border px-10 gap-5 grid-cols-3 grid-rows-2">
        <div className="p-5 shadow-md bg-transparent border-2 border-secondary rounded-xl">
          <h2 className="text-text font-roboto font-medium text-3xl mb-2">
            <FaSearch className="mb-1 mr-2 inline-block" />
            Exploration
          </h2>
          <p className="text-accent text-lg font-roboto font-light">
        ...
        <div className="p-5 shadow-md bg-transparent border-2 border-secondary rounded-xl">
          ...
          <p className="text-accent text-lg font-roboto font-light">
            ...
            material, such as personal books, conspect, etc. Because of that,
            the AI is capable of providing up-to-date and specific knowledge.
          </p>
        </div>
        <div className="p-5 shadow-md bg-transparent border-2 border-secondary rounded-xl">
          <h2 className="text-text font-roboto font-medium text-3xl mb-2">
