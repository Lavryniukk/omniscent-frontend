...
export default function ConversationInput({
  ...
  return (
    ...
    >
      <textarea
        ref={textareaRef}
        className={`w-full h-[70px] box-border bg-secondary-950 rounded-xl p-5 pr-16 aspect-none placeholder:text-lg text-accent text-lg
           focus:outline-none focus:bg-secondary-900 resize-none max-h-[200px] overflow-y-scroll  `}
