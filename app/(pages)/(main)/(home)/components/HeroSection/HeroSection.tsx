...
let HeroSection = () => {
  return (
    <div className="py-28 max-h-[1000px] h-screen min-h-[700px] relative overflow-hidden flex flex-col items-center">
      ...
      <div
        className={`left-0 background-left origin-left animate-movingBackgroundLeft -z-50 opacity-90 w-[50%] h-[120vh] absolute -top-[10vh]`}
      >
      ...
      <div
        className={`right-0 background-right origin-right animate-movingBackgroundRight -z-50 opacity-90 w-[50%] h-[120vh] absolute -top-[10vh] `}
      >
