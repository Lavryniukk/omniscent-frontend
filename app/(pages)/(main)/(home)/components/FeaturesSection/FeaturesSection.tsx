...
let FeaturesSection = () => {
  return (
    <div className="box-border w-full  xl:max-h-[800px] min-h-fit h-fit overflow-hidden  xl:h-screen  flex-col  mx-auto space-y-20 overflow-x-hidden font-normal bg-transparent relative max-w-10xl">
