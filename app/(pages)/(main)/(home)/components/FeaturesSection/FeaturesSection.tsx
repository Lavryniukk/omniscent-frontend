...
let FeaturesSection = () => {
  return (
    <div className="box-border w-full  md:max-h-[1200px] min-h-fit h-fit md:h-screen flex items-center justify-center flex-col py-20 mx-auto space-y-10 overflow-x-hidden font-normal px-4 bg-transparent relative max-w-10xl">
