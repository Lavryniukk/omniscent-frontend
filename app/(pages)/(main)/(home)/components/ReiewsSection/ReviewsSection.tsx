...
const ReviewsSection = () => {
  return (
    <div className="section relative overflow-hidden border-t border-secondary w-full mx-auto before:absolute before:top-0 before:w-full before:right-0 before:h-16 before:bg-gradient-to-t before:from-background before:to-primary-950 before:blur-3xl">
      <div className="box-border overflow-hidden relative  w-full mx-auto space-y-10 overflow-x-hidden font-normal p-4 bg-transparent h-fit max-w-10xl ">
        <h2 className="text-center text-text duration-500 transition text-4xl font-medium font">
          Reviews
        </h2>
        <div className="max-w-[1200px] w-full space-y-2 lg:space-x-2 sm:w-3/4 md:w-1/2 lg:w-full mx-auto gap-2 flex lg:flex-row flex-col">
          <ReviewCard
            ...
            className=" duration-500 delay-0 transition"
          />
          ...
          <ReviewCard
            ...
            className=" duration-500 delay-75 transition"
          />
          <div className="lg:w-0.5 lg:h-auto w-full h-0.5 bg-secondary block " />
          <ReviewCard
            rating={4}
            ...
            className=" duration-500 delay-150 transition"
          />
        </div>
      </div>
    </div>
