      ...
      <div>
        ...
        <ul className="list-disc list-inside text-lg space-y-10  mt-2">
          <li>
            ...
            By simply inputting their desired technology focus – be it Nest.js
            backend, data science, or game development – users receive a
            custom-designed learning pathway. This roadmap is visually presented
            as a series of interconnected nodes, each representing a specific
            technology or topic, akin to a journey map guiding learners through
            the complex terrain of digital technology.
          </li>
          <li>
